...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
			...
			<div class="providerAdd">
				...
				<div>
					<label>出生日期:</label>
					<input type="text" id="v_birthday" value="" class="Wdate" readonly="readonly" onclick="WdatePicker()">
				</div>
				<div>
					<label>用户电话:</label>
				...
				<div>
					<label>创建日期:</label>
					<input type="text" class="Wdate" id="v_creationDate" value="" readonly="readonly" onclick="WdatePicker()">
				</div>
			</div>
